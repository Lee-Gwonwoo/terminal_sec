...
### Session — 실행 의존성 그래프 전면 수정 (planning.md 지침 준수)

**작성 시각:** 15:18 (local)
**Status: done**

#### 배경
- planning.md 스킬 지침의 3곳 일관성 규칙(대단계 제목 · 의존성 그래프 · 세부 단계 테이블)이 그래프에 미반영 상태였음
- 그래프에 누락/불일치가 다수 발견되어 전면 수정

#### 수정 내용

| 항목 | Before | After |
|------|--------|-------|
| Step 0 그래프 heading | ⏳ | ✅ (전 sub ✅) |
| Step 0 sub-steps | 0-2b, 0-2c 누락 | 추가 |
| Step 1 그래프 heading | ⏳ | ✅ (전 sub ✅) |
| Step 2 그래프 heading | ⏳ | ✅ (전 sub ✅) |
| Step 3 그래프 heading | ⏳ | ✅ (전 sub ✅) |
| Step 4 sub-steps | 4-1~4-5만 표시 | 4-4a, 4-6, 4-7, 4-8, 4-9 추가 |
| 5-9 상태 | ⏳ | ✅ (테이블 기준) |
| Step 5 sub-steps | 5-12~5-14, 5-20~5-23 누락 | 전부 추가 (총 25개) |
| Step 6-7 sub emojis | 없음 | ⬜ 표시 |
| Step 7 인덴트 | 7-8, 7-9 들여쓰기 불일치 | 정렬 |
| Step 8 sub emojis | 없음 | 🚫 표시 |
| Step 8 8-3 인덴트 | 들여쓰기 불일치 | 정렬 |
| Step 9 sub emojis | 없음 | ⬜ 표시 |
| Step 10 heading | ⬜ | ⏳ (전 sub ⏳/⬜) |
| Step 10 sub emojis | 없음 | ⏳ (10-1~14), ⬜ (10-15) |
| Step 10 10-15 | 누락 | 추가 |
| 0단계 본문 heading | ⏳ | ✅ |

#### 수정 파일
- `ai_agent_plan/terminal_ui_ver2_finhub/plan.md` — 실행 의존성 그래프 섹션 + 대단계 제목 (0단계, 1단계, 2단계)
