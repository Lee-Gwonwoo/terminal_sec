...
| --- | --- | ---: | ---: | ---: |
| residual | 잡것들 | 359,680 | 62,272 | 1760.66 |
| long | 애널리스트 상향·커버리지 개시 | 30,428 | 5,025 | 976.58 |
| short | 애널리스트 하향·목표가 하향 | 25,430 | 3,709 | 1202.82 |
| long | 출시·상업화·확장 | 24,046 | 3,855 | 953.52 |
| residual | 매크로·시장 코멘터리 | 23,527 | 3,667 | 971.43 |
| residual | feature·투자아이디어 해설 | 16,440 | 3,194 | 1096.77 |
| long | 제휴·라이선스·협업 | 15,764 | 2,758 | 1044.21 |
| residual | 실적 transcript·snapshot | 15,567 | 3,022 | 1760.66 |
| long | M&A·전략자산 거래 | 11,834 | 1,711 | 486.06 |
| long | 실적 호조·가이던스 상향 | 11,821 | 2,378 | 1114.55 |
| short | peer 투자·경쟁 심화 read-through | 7,777 | 1,235 | 1236.81 |
| short | 소송·조사·회계 리스크 | 7,656 | 1,758 | 795.85 |
| short | top mover·헤드라인 증폭·하락 해설 | 5,839 | 1,529 | 1117.17 |
| long | 밸류에이션 discount 해소 narrative | 5,408 | 738 | 228.22 |
| residual | 리스트형 screener·주간 요약 노이즈 | 3,975 | 740 | 2267.06 |
| residual | 행사·인터뷰·홍보성 appearance | 3,512 | 563 | 1109.86 |
| long | top mover·헤드라인 증폭·상승 해설 | 3,477 | 1,359 | 648.56 |
| short | 희석성 자금조달 | 3,435 | 881 | 675.10 |
| long | 수요 급증·백로그 확대 | 3,121 | 516 | 1236.81 |
| long | 자사주 매입·주주환원 | 2,523 | 336 | 216.53 |
| short | 구조조정·생존성 악화 | 2,316 | 366 | 133.56 |
| long | 고객 채택·대형 고객 확보 | 1,876 | 309 | 120.08 |
| residual | 멀티종목 movers·watchlist 기사 | 1,860 | 606 | 638.43 |
| long | 숏커버·포지셔닝 언와인드·매수 유입 | 1,509 | 277 | 712.75 |
| short | 공급망 차질·원가 압박 read-through | 1,415 | 534 | 780.14 |
| long | 승인·임상 호재 | 1,364 | 284 | 648.56 |
| short | 밸류에이션 부담·multiple compression narrative | 1,323 | 286 | 516.05 |
| residual | IPO·상장 이벤트 | 1,130 | 284 | 675.10 |
| residual | 실적 발표 전 기대 기사 | 1,116 | 250 | 1273.44 |
| long | 애널리스트 코멘트 증폭·긍정 | 975 | 242 | 92.18 |
| short | 실적 부진·가이던스 하향 | 889 | 200 | 1760.66 |
| long | 정부·대형 계약 수주 | 581 | 157 | 1511.26 |
| short | 정책·법안 역풍 read-through | 552 | 110 | 64.58 |
| short | 규제·임상 악재 | 379 | 101 | 371.07 |
| short | 거래정지·역분할·상장유지 스트레스 | 368 | 180 | 3646.27 |
| short | 차익실현·디그로싱·매도 수급 | 249 | 81 | 120.19 |
| long | 경영진 보강·거버넌스 개선 | 207 | 34 | 93.87 |
| short | 애널리스트 코멘트 증폭·부정 | 121 | 24 | 661.98 |
| long | 정책·법안 수혜 read-through | 85 | 20 | 63.77 |
| long | peer 호조 read-through | 78 | 10 | 264.36 |
...
- 집계: total=359,680, impacted=62,272, max impact=1760.66
- 대표 예시:
...
- 집계: total=30,428, impacted=5,025, max impact=976.58
- 대표 예시:
...
- 집계: total=25,430, impacted=3,709, max impact=1202.82
- 대표 예시:
...
- 집계: total=24,046, impacted=3,855, max impact=953.52
- 대표 예시:
...
- 집계: total=23,527, impacted=3,667, max impact=971.43
- 대표 예시:
...
- 집계: total=16,440, impacted=3,194, max impact=1096.77
- 대표 예시:
...
- 집계: total=15,764, impacted=2,758, max impact=1044.21
- 대표 예시:
...
- 집계: total=15,567, impacted=3,022, max impact=1760.66
- 대표 예시:
...
- 집계: total=11,834, impacted=1,711, max impact=486.06
- 대표 예시:
...
- 집계: total=11,821, impacted=2,378, max impact=1114.55
- 대표 예시:
...
- 집계: total=7,777, impacted=1,235, max impact=1236.81
- 대표 예시:
...
- 집계: total=7,656, impacted=1,758, max impact=795.85
- 대표 예시:
...
- 집계: total=5,839, impacted=1,529, max impact=1117.17
- 대표 예시:
...
- 집계: total=5,408, impacted=738, max impact=228.22
- 대표 예시:
...
### 리스트형 screener·주간 요약 노이즈 (`screener_listicle_noise`)
- 상위 분류: `residual`
- 한 줄 정의: Why these stocks, top meme stocks, penny stocks listicle, week-in-review 같은 리스트형 기사다.
- 핵심 가치 경로: 개별 종목의 독립 원인보다 트래픽 유도형 큐레이션 성격이 강하다.
- 포함 신호: why these, best meme stocks, penny stocks, what you need to know
- 제외 신호: single-ticker explainer, 구체적 직접 사건
- 빠른 판별 질문: 리스트형/큐레이션 기사인가? / 개별 원인 설명보다 모음집 구조인가?
- 집계: total=3,975, impacted=740, max impact=2267.06
- 대표 예시:
  ...
  - 2025-12-18T13:05:06 | IPSC | 3 Promising Penny Stocks With Market Caps Over $30M | score=246.12 | tag=multi_window_impact

### 행사·인터뷰·홍보성 appearance (`promotional_appearance_noise`)
- 상위 분류: `residual`
- 한 줄 정의: conference participation, fireside chat, podcast, webinar, event appearance 같은 홍보성 노출 기사다.
- 핵심 가치 경로: 직접 가격 설명보다 investor-relations 노출 성격이 강해 true residual에 가깝다.
- 포함 신호: participate in, investor conference, podcast featuring, fireside chat
- 제외 신호: 실적발표, 계약수주, 정책 read-through
- 빠른 판별 질문: 행사 참가/인터뷰 공지인가? / 직접 가치 경로보다 홍보성 노출이 중심인가?
- 집계: total=3,512, impacted=563, max impact=1109.86
- 대표 예시:
...
- 집계: total=3,477, impacted=1,359, max impact=648.56
- 대표 예시:
...
- 집계: total=3,435, impacted=881, max impact=675.10
- 대표 예시:
...
- 집계: total=3,121, impacted=516, max impact=1236.81
- 대표 예시:
...
- 집계: total=2,523, impacted=336, max impact=216.53
- 대표 예시:
...
- 집계: total=2,316, impacted=366, max impact=133.56
- 대표 예시:
...
- 집계: total=1,876, impacted=309, max impact=120.08
- 대표 예시:
...
- 집계: total=1,860, impacted=606, max impact=638.43
- 대표 예시:
...
- 집계: total=1,509, impacted=277, max impact=712.75
- 대표 예시:
...
- 집계: total=1,415, impacted=534, max impact=780.14
- 대표 예시:
...
- 집계: total=1,364, impacted=284, max impact=648.56
- 대표 예시:
...
- 집계: total=1,323, impacted=286, max impact=516.05
- 대표 예시:
...
- 집계: total=1,130, impacted=284, max impact=675.10
- 대표 예시:
...
- 집계: total=1,116, impacted=250, max impact=1273.44
- 대표 예시:
...
- 집계: total=975, impacted=242, max impact=92.18
- 대표 예시:
...
- 집계: total=889, impacted=200, max impact=1760.66
- 대표 예시:
  ...
  - 2025-05-09T09:08:00 | NKTR | Nektar Q1 Loss Wider Than Expected, Revenues Fall Y/Y, Stock Down | score=1440.32 | tag=sustained_repricing
...
- 집계: total=581, impacted=157, max impact=1511.26
- 대표 예시:
...
- 집계: total=552, impacted=110, max impact=64.58
- 대표 예시:
...
- 집계: total=379, impacted=101, max impact=371.07
- 대표 예시:
...
- 집계: total=368, impacted=180, max impact=3646.27
- 대표 예시:
...
- 집계: total=249, impacted=81, max impact=120.19
- 대표 예시:
...
- 집계: total=207, impacted=34, max impact=93.87
- 대표 예시:
...
- 집계: total=121, impacted=24, max impact=661.98
- 대표 예시:
...
- 집계: total=78, impacted=10, max impact=264.36
- 대표 예시:
