# 🎯 model 2-claude opus 4.6 /version 3/description,ipo date, peers/final 

---

## 📌 분석 전제

- 생성 시각: 2026-03-13 00:00 (local)
...
- `company_profiles.description`은 yahoo 우선 기준으로 1683/1698 ticker에서 확보되며, 이번 분석에서는 industry 보정의 2차 컨텍스트로 사용했다.

## 🗂️ 빠른 요약 표

| 상위 분류 | 순위 | case_type | 총 건수 | 영향 미침 | 영향 비율 | Wilson LB |
| --- | --- | --- | ---: | ---: | ---: | ---: |
| 🟢 long | 1 | 실적 호조·가이던스 상향 | 343 | 113 | 0.329 | 0.282 |
| 🟢 long | 2 | 임상·규제 성공 | 5,098 | 1,428 | 0.280 | 0.268 |
| 🟢 long | 3 | 상업화·시설·사업 확장 | 17,741 | 3,825 | 0.216 | 0.210 |
| 🟢 long | 4 | 전략 제휴·라이선스·정부지원·대형 계약 | 16,423 | 3,032 | 0.185 | 0.179 |
| 🟢 long | 5 | 상장·직상장·자본시장 구조 이벤트 | 260 | 53 | 0.204 | 0.159 |
| 🔴 short | 1 | 소송·조사·회계 이슈 | 1,231 | 316 | 0.257 | 0.233 |
| 🔴 short | 2 | 임상·규제 실패 | 175 | 51 | 0.291 | 0.229 |
| 🔴 short | 3 | 희석성 자금조달·오퍼링 | 6,393 | 1,339 | 0.209 | 0.200 |
| 🔴 short | 4 | 실적 부진·가이던스 하향 | 62 | 17 | 0.274 | 0.179 |
| 🔴 short | 5 | 전략대안·구조조정·생존성 | 285 | 62 | 0.218 | 0.174 |
| ⚪ residual | 1 | 일반 corporate PR | 65,409 | 12,475 | 0.191 | 0.188 |
| ⚪ residual | 2 | 애널리스트 의견·목표가 | 761 | 154 | 0.202 | 0.175 |
| ⚪ residual | 3 | 정책·관세·섹터 매크로 | 341 | 44 | 0.129 | 0.098 |
...
#### long-1. 실적 호조·가이던스 상향 (`earnings_guidance_positive`)
- 상위 분류: `long`
...
#### long-2. 임상·규제 성공 (`clinical_regulatory_positive`)
- 상위 분류: `long`
...
- 집계: impacted=1,428 / total=5,098, ratio=0.280

#### long-3. 상업화·시설·사업 확장 (`commercial_launch_expansion`)
- 상위 분류: `long`
...
- 집계: impacted=3,825 / total=17,741, ratio=0.216

#### long-4. 전략 제휴·라이선스·정부지원·대형 계약 (`strategic_deal_policy`)
- 상위 분류: `long`
...
- 집계: impacted=3,032 / total=16,423, ratio=0.185

#### long-5. 상장·직상장·자본시장 구조 이벤트 (`listing_capital_markets`)
- 상위 분류: `long`
...
#### short-1. 소송·조사·회계 이슈 (`litigation_investigation`)
- 상위 분류: `short`
...
- 집계: impacted=316 / total=1,231, ratio=0.257

#### short-2. 임상·규제 실패 (`clinical_regulatory_negative`)
- 상위 분류: `short`
...
- 집계: impacted=51 / total=175, ratio=0.291

#### short-3. 희석성 자금조달·오퍼링 (`financing_offering`)
- 상위 분류: `short`
...
- 집계: impacted=1,339 / total=6,393, ratio=0.209

#### short-4. 실적 부진·가이던스 하향 (`earnings_guidance_negative`)
- 상위 분류: `short`
...
#### short-5. 전략대안·구조조정·생존성 (`strategic_review_restructuring`)
- 상위 분류: `short`
...
- 집계: impacted=62 / total=285, ratio=0.218

### ⚪ residual

#### residual-1. 일반 corporate PR (`general_corporate_pr`)
- 상위 분류: `residual`
...
- 집계: impacted=12,475 / total=65,409, ratio=0.191

#### residual-2. 애널리스트 의견·목표가 (`analyst_rating_target`)
- 상위 분류: `residual`
...
#### residual-3. 정책·관세·섹터 매크로 (`macro_policy_sector`)
- 상위 분류: `residual`
...
- 근거 표 파일 경로: `ai_research_tool\model_2_source\model 2-claude opus 4.6 version 3description,ipo date, peersfinal.md`
...
| source_type | total | with_change | with_fulltext |
| --- | ---: | ---: | ---: |
| press_release | 137,037 | 114,522 | 53,688 |

## 📊 market cap bucket별 impact 기준

| bucket | total | with_change | p50 | p80 | p90 |
| --- | ---: | ---: | ---: | ---: | ---: |
| $300M~1B | 24,404 | 9,734 | 16.84 | 30.85 | 43.03 |
| $1B~10B | 57,392 | 53,898 | 12.27 | 23.06 | 32.60 |
| $10B~100B | 40,152 | 39,867 | 7.71 | 14.56 | 20.45 |
| $100B~300B | 10,064 | 8,366 | 6.62 | 11.47 | 15.03 |
| $300B~ | 3,383 | 1,385 | 8.38 | 15.37 | 20.10 |
| <$300M or Unknown | 1,642 | 1,272 | 10.99 | 20.59 | 28.18 |
...
- 방향 분해: positive 950 / negative 478
- median impact score: 13.26
- market cap breakdown: {"$10B~100B": {"total": 1028, "impacted": 249}, "$1B~10B": {"total": 2686, "impacted": 859}, "$300M~1B": {"total": 739, "impacted": 213}, "$100B~300B": {"total": 469, "impacted": 69}, "$300B~": {"total": 130, "impacted": 10}, "<$300M or Unknown": {"total": 46, "impacted": 28}}
- source breakdown: {"press_release": {"total": 5098, "impacted": 1428}}
- industry group breakdown: {"Biotech/Pharma/MedDev": {"total": 4723, "impacted": 1322}, "Technology": {"total": 115, "impacted": 24}, "Industrial": {"total": 59, "impacted": 18}, "Energy/Mining": {"total": 18, "impacted": 11}, "Other": {"total": 83, "impacted": 17}, "Unknown": {"total": 46, "impacted": 28}, "Materials/Auto": {"total": 19, "impacted": 0}, "Financial": {"total": 19, "impacted": 5}, "Utilities": {"total": 16, "impacted": 3}}
- 대표 사례:
...
- 방향 분해: positive 2,546 / negative 1,279
- median impact score: 10.61
- market cap breakdown: {"$1B~10B": {"total": 8596, "impacted": 1826}, "$300M~1B": {"total": 1487, "impacted": 272}, "$10B~100B": {"total": 6034, "impacted": 1407}, "$100B~300B": {"total": 1204, "impacted": 233}, "<$300M or Unknown": {"total": 220, "impacted": 39}, "$300B~": {"total": 200, "impacted": 48}}
- source breakdown: {"press_release": {"total": 17741, "impacted": 3825}}
- industry group breakdown: {"Energy/Mining": {"total": 668, "impacted": 229}, "Other": {"total": 4072, "impacted": 854}, "Biotech/Pharma/MedDev": {"total": 3031, "impacted": 615}, "Technology": {"total": 4611, "impacted": 1050}, "Materials/Auto": {"total": 1137, "impacted": 191}, "Financial": {"total": 1052, "impacted": 230}, "Utilities": {"total": 921, "impacted": 158}, "Industrial": {"total": 2029, "impacted": 459}, "Unknown": {"total": 220, "impacted": 39}}
- 대표 사례:
...
- 방향 분해: positive 1,966 / negative 1,066
- median impact score: 9.46
- market cap breakdown: {"$1B~10B": {"total": 7270, "impacted": 1295}, "$300M~1B": {"total": 1225, "impacted": 259}, "$10B~100B": {"total": 6120, "impacted": 1129}, "$100B~300B": {"total": 1437, "impacted": 283}, "$300B~": {"total": 247, "impacted": 50}, "<$300M or Unknown": {"total": 124, "impacted": 16}}
- source breakdown: {"press_release": {"total": 16423, "impacted": 3032}}
- industry group breakdown: {"Industrial": {"total": 2271, "impacted": 499}, "Technology": {"total": 4885, "impacted": 916}, "Utilities": {"total": 1093, "impacted": 181}, "Materials/Auto": {"total": 901, "impacted": 134}, "Biotech/Pharma/MedDev": {"total": 2343, "impacted": 430}, "Other": {"total": 3477, "impacted": 604}, "Energy/Mining": {"total": 468, "impacted": 125}, "Financial": {"total": 861, "impacted": 127}, "Unknown": {"total": 124, "impacted": 16}}
- 대표 사례:
...
- 방향 분해: positive 195 / negative 121
- median impact score: 12.05
- market cap breakdown: {"$100B~300B": {"total": 37, "impacted": 8}, "$10B~100B": {"total": 383, "impacted": 128}, "$300M~1B": {"total": 155, "impacted": 25}, "$1B~10B": {"total": 636, "impacted": 150}, "<$300M or Unknown": {"total": 9, "impacted": 1}, "$300B~": {"total": 11, "impacted": 4}}
- source breakdown: {"press_release": {"total": 1231, "impacted": 316}}
- industry group breakdown: {"Technology": {"total": 367, "impacted": 69}, "Biotech/Pharma/MedDev": {"total": 377, "impacted": 84}, "Other": {"total": 218, "impacted": 103}, "Energy/Mining": {"total": 23, "impacted": 3}, "Industrial": {"total": 68, "impacted": 22}, "Materials/Auto": {"total": 70, "impacted": 9}, "Unknown": {"total": 9, "impacted": 1}, "Financial": {"total": 41, "impacted": 20}, "Utilities": {"total": 58, "impacted": 5}}
- 대표 사례:
...
- 영향 안 미침: 124
- 영향 비율: 0.291
- 보수적 순위 점수(Wilson LB): 0.229
- 방향 분해: positive 20 / negative 31
- median impact score: 14.36
- market cap breakdown: {"$1B~10B": {"total": 78, "impacted": 30}, "$300M~1B": {"total": 30, "impacted": 11}, "$100B~300B": {"total": 24, "impacted": 3}, "$10B~100B": {"total": 38, "impacted": 6}, "$300B~": {"total": 3, "impacted": 1}, "<$300M or Unknown": {"total": 2, "impacted": 0}}
- source breakdown: {"press_release": {"total": 175, "impacted": 51}}
- industry group breakdown: {"Industrial": {"total": 3, "impacted": 0}, "Biotech/Pharma/MedDev": {"total": 162, "impacted": 49}, "Materials/Auto": {"total": 3, "impacted": 1}, "Technology": {"total": 2, "impacted": 1}, "Unknown": {"total": 2, "impacted": 0}, "Other": {"total": 2, "impacted": 0}, "Utilities": {"total": 1, "impacted": 0}}
- 대표 사례:
...
- market cap breakdown: {"$100B~300B": {"total": 341, "impacted": 81}, "$1B~10B": {"total": 3465, "impacted": 745}, "$300M~1B": {"total": 580, "impacted": 133}, "$10B~100B": {"total": 1887, "impacted": 364}, "<$300M or Unknown": {"total": 83, "impacted": 11}, "$300B~": {"total": 37, "impacted": 5}}
- source breakdown: {"press_release": {"total": 6393, "impacted": 1339}}
- industry group breakdown: {"Industrial": {"total": 694, "impacted": 156}, "Materials/Auto": {"total": 444, "impacted": 50}, "Biotech/Pharma/MedDev": {"total": 1944, "impacted": 477}, "Other": {"total": 1243, "impacted": 220}, "Technology": {"total": 781, "impacted": 193}, "Financial": {"total": 277, "impacted": 56}, "Energy/Mining": {"total": 239, "impacted": 78}, "Utilities": {"total": 688, "impacted": 98}, "Unknown": {"total": 83, "impacted": 11}}
- 대표 사례:
...
- 영향 안 미침: 223
- 영향 비율: 0.218
- 보수적 순위 점수(Wilson LB): 0.174
- 방향 분해: positive 47 / negative 15
- median impact score: 10.62
- market cap breakdown: {"$1B~10B": {"total": 125, "impacted": 27}, "$10B~100B": {"total": 110, "impacted": 18}, "$100B~300B": {"total": 22, "impacted": 7}, "$300M~1B": {"total": 23, "impacted": 9}, "<$300M or Unknown": {"total": 4, "impacted": 1}, "$300B~": {"total": 1, "impacted": 0}}
- source breakdown: {"press_release": {"total": 285, "impacted": 62}}
- industry group breakdown: {"Biotech/Pharma/MedDev": {"total": 37, "impacted": 11}, "Financial": {"total": 61, "impacted": 10}, "Materials/Auto": {"total": 28, "impacted": 2}, "Technology": {"total": 43, "impacted": 10}, "Industrial": {"total": 24, "impacted": 8}, "Other": {"total": 72, "impacted": 15}, "Unknown": {"total": 4, "impacted": 1}, "Utilities": {"total": 10, "impacted": 2}, "Energy/Mining": {"total": 6, "impacted": 3}}
- 대표 사례:
...
- 방향 분해: positive 8,185 / negative 4,290
- median impact score: 9.94
- market cap breakdown: {"$100B~300B": {"total": 4625, "impacted": 947}, "$1B~10B": {"total": 30343, "impacted": 5685}, "$10B~100B": {"total": 23585, "impacted": 4536}, "$300M~1B": {"total": 5345, "impacted": 994}, "<$300M or Unknown": {"total": 775, "impacted": 158}, "$300B~": {"total": 736, "impacted": 155}}
- source breakdown: {"press_release": {"total": 65409, "impacted": 12475}}
- industry group breakdown: {"Energy/Mining": {"total": 2857, "impacted": 795}, "Utilities": {"total": 4540, "impacted": 533}, "Technology": {"total": 15825, "impacted": 3177}, "Financial": {"total": 3466, "impacted": 499}, "Industrial": {"total": 5401, "impacted": 1111}, "Biotech/Pharma/MedDev": {"total": 14398, "impacted": 3107}, "Other": {"total": 14417, "impacted": 2550}, "Materials/Auto": {"total": 3730, "impacted": 545}, "Unknown": {"total": 775, "impacted": 158}}
- 대표 사례:
...
- 1. 임상·규제 성공: impacted=213 / total=739, ratio=0.288, Wilson=0.257
...
- 5. 전략 제휴·라이선스·정부지원·대형 계약: impacted=259 / total=1,225, ratio=0.211, Wilson=0.189

### $1B~10B 상위 case

- 1. 임상·규제 성공: impacted=859 / total=2,686, ratio=0.320, Wilson=0.302
- 2. 임상·규제 실패: impacted=30 / total=78, ratio=0.385, Wilson=0.284
...
- 5. 상업화·시설·사업 확장: impacted=1,826 / total=8,596, ratio=0.212, Wilson=0.204

### $10B~100B 상위 case

- 1. 소송·조사·회계 이슈: impacted=128 / total=383, ratio=0.334, Wilson=0.289
- 2. 실적 호조·가이던스 상향: impacted=33 / total=90, ratio=0.367, Wilson=0.274
- 3. 상업화·시설·사업 확장: impacted=1,407 / total=6,034, ratio=0.233, Wilson=0.223
- 4. 임상·규제 성공: impacted=249 / total=1,028, ratio=0.242, Wilson=0.217
- 5. 일반 corporate PR: impacted=4,536 / total=23,585, ratio=0.192, Wilson=0.187
...
- `industry` (securities.industry): 1695/1698 ticker 보유 (99.8%). clinical_regulatory 유형 분류 보정에 활용 중.
- `description` (company_profiles.description, yahoo 우선): 1683/1698 ticker 보유 (99.1%). clinical/biotech 여부 판단의 2차 보정 레이어로 활용 중.
  - industry가 CLINICAL_CORE_INDUSTRIES에 없더라도, description에서 biotech/pharma/therapeutic 등 핵심 키워드가 감지되면 clinical_regulatory 분류를 유지한다.
  - description source 우선순위: yahoo(1683건) > fmp(51건) > finnhub(0건).
...
- **industry + description 기반 분류 보정**: 비(非)임상 산업에서 'approval', 'study' 같은 범용 키워드가 잡히면 clinical_regulatory로 오분류될 수 있으므로, industry가 Biotech/Pharma/MedDev가 아니고 description에서도 임상/바이오 핵심 키워드가 없는 경우 strong clinical signal 유무로 필터링했다.
