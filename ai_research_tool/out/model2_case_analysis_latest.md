...
- 집계: impacted=116 / total=343, ratio=0.338
...
- 집계: impacted=1,710 / total=6,238, ratio=0.274
...
- 집계: impacted=3,745 / total=17,548, ratio=0.213
...
- 집계: impacted=2,966 / total=16,176, ratio=0.183
...
- 집계: impacted=47 / total=260, ratio=0.181
...
- 집계: impacted=321 / total=1,215, ratio=0.264
...
- 집계: impacted=86 / total=313, ratio=0.275
...
- 집계: impacted=1,387 / total=6,364, ratio=0.218
...
- 집계: impacted=60 / total=276, ratio=0.217
...
- 집계: impacted=13 / total=61, ratio=0.213
...
- 집계: impacted=12,282 / total=64,664, ratio=0.190
...
- 집계: impacted=137 / total=740, ratio=0.185
...
- 집계: impacted=36 / total=324, ratio=0.111
...
- 영향 안 미침: 288
- 영향 비율: 0.111
- 보수적 순위 점수(Wilson LB): 0.081
- 방향 분해: positive 25 / negative 11
- median impact score: 7.06
- market cap breakdown: {"$1B-<$100B": {"total": 224, "impacted": 26}, ">$=100B": {"total": 79, "impacted": 6}, "$300M-<$1B": {"total": 16, "impacted": 3}, "<$300M or Unknown": {"total": 5, "impacted": 1}}
- source breakdown: {"press_release": {"total": 324, "impacted": 36}}
- 대표 사례:
  - 8da194a2-3e55-4870-b299-a2a738dd8ee7 | 2025-05-07 17:16:00 | press_release | LEU | Centrus Reports First Quarter 2025 Results | change=-2.6323 | change_1d=18.802 | change_3d=27.1958 | change_7d=30.1638 | intraday=-4.6053 | tag=multi_window_impact | cap=$1B-<$100B
  - 22c5b1df-3354-465c-aa14-2447b291a7c8 | 2024-05-16 06:00:00 | press_release | HIMS | Hims & Hers Welcomes Anja Manuel, Foreign Policy Expert, Domestic Regulations Advisor, and Former Diplomat to its Board of Directors | change=1.4451 | change_1d=5.2746 | change_3d=26.8786 | change_7d=14.3786 | intraday=1.5184 | tag=multi_window_impact | cap=$1B-<$100B
...
- 반례/영향 약한 사례:
  ...
  - bfb3687c-28ea-42fc-9be5-ff640f707e9a | 2024-07-01 09:00:00 | press_release | CME | CME Group Launches €STRWatch to Help Clients Manage Risk Around ECB Policy Decisions | change=-0.5595 | change_1d=0.2442 | change_3d=-0.1017 | change_7d=-1.0071 | intraday=-1.0728 | tag=low_signal | cap=>$=100B
